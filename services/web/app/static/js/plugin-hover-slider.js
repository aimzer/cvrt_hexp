var jsPsychHtmlHoverSlider = (function (jspsych) {
    'use strict';
    ...
    class HtmlHoverSliderPlugin {
        ...
        trial(display_element, trial) {
            ...
            display_element.querySelector("#jspsych-html-slider-response-response").addEventListener('mousemove', function(e) {
            ...
            display_element.querySelector("#jspsych-html-slider-response-response").addEventListener('mouseup', function(e) {
    ...
    HtmlHoverSliderPlugin.info = info;
  
    return HtmlHoverSliderPlugin;
